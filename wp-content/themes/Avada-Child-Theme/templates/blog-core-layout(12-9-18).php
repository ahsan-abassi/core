			...
			<article id="post-<?php the_ID(); ?>" <?php post_class( $post_classes ); ?>>
				<?php if ( 'grid' === $blog_layout_custom ) : ?>
					...
					<div class="fusion-post-wrapper archieve-page-div">
						<ul style="padding: 0;">
							<li class ="archieve-page-li" style="background-image: url('<?php echo $thumbnail_img_url; ?>')">
								<a href="<?php echo $permalink_url; ?>">
									<div class="text archieve-page-text">
										<!-- <span class="date"><?php //echo esc_attr( get_the_modified_time( 'F j, Y' ) ); ?></span> -->
										<h3 class="archieve-page-h3"><?php the_title();?></h3>
									</div>
								</a>
							</li>
						</ul>
						<div class="fusion-post-content-container archieve-page-p">
                            <?php
                            $content = get_the_content();
                            echo mb_strimwidth($content, 0, 95, '...');
                            ?>
                            <a class="more" style="width: 20%;" href="<?php echo $permalink_url; ?>">Read More</a>
						</div>
				<?php endif; ?>
			</article>
